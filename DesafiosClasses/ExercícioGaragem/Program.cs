// Trabalho para entender e aplicar a teoria de Orientação a Objetos (terceirização), uso
// adequado de Listas e Arquivos. Além disso, aplicar a ideia de menu de opções.

// Construir um programa em VS que gerencie veículos em garagem. O programa deve ter um menu
// de operação. Os dados dos veículos devem ser persistidos em arquivo e manipulados em uma
...
// StreamReader, StreamWriter, DateTime
// Use como base de dados o arquivo 'garagem.dat'.

using ExercícioGaragem;
...
do
{
    ...
    Console.Write("Precione algo para continuar!");
    Console.ReadKey();
} while (opcao != "3");

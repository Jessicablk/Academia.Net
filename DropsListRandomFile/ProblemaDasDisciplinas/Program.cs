//Problema das listagens dos alunos (disciplinas de Estruturas de Dados e Linguagem de
//Programação) -Arquivos.txt com nomes dos matriculados (matricula; nome; email)
...
do
{
    ...
    Console.WriteLine("Precione algo para continuar!"); Console.ReadKey();
} while (opcao != "4");
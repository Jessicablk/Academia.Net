...
namespace ProblemaDasDisciplinas
{
    ...
    {
        /// <summary>
        /// metodo de classe que recebe uma lista de alunos e a exibe no console/terminal
        /// </summary>
        ...
        public static void exibirLista(string frase, List<Aluno> lista)
        {
            ...
            {
                Console.WriteLine(i.Matricula + " - " + i.pegarNomeSobrenome + " - " + i.Email);
            }
        }
        /// <summary>
        /// metodo de classe que abre dois arquivos texto com nomes de alunos em disciplinas e popula nas listas
        /// </summary>
        /// <param name="lista1">contem todos os alunos da disciplina 1</param>
        /// <param name="lista2">contem todos os alunos da disciplina 2</param>
        public static void carregarListas(List<Aluno> lista1, List<Aluno> lista2)
        {
            ...
            try
            {
                ...
                do
                {
                    ...
                    //temporario = new Aluno(vetorDados[0], vetorDados[1], vetorDados[2]);
                    //lista1.Add(temporario); //ou 
                    lista1.Add(new Aluno(vetorDados[0], vetorDados[1], vetorDados[2]));
                }while (!leitor.EndOfStream);// repete-se a leitura ate que o leitor não chegue no final do arquivo
            }
            catch (Exception e)
            {
            ...
            try
            {
                ...
                do
                {
                    vetorDados = leitor.ReadLine().Split(';');//matricula;nome;email
                    //temporario = new Aluno(vetorDados[0], vetorDados[1], vetorDados[2]);
                    //lista2.Add(temporario); //ou
                    lista2.Add(new Aluno(vetorDados[0], vetorDados[1], vetorDados[2]));
                }while (!leitor.EndOfStream); //repete-se a leitura ate que o leitor não chegue no final do aquivo
            }
            catch(Exception e)
            {

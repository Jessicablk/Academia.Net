// 1) Fazer um programa em VS que gere uma lista com n valores randômicos e inteiros para glicemia
// (entre 45 a 500). 
...
// 4 - Sair
// Opção: ____
// Observação, toda vez que a opção 1 for acionada, o usuário deve definir quantos números serão
// gerados na lista

// listaGlicemia é um objeto da classe List, logo tem atributos e métodos vindos da classe:
// Count; Add(); Contains()
List<int> listaGlicemia = new List<int>();

// opcao é um objeto da classe string, logo tem atributos e métodos vindos da classe:
// ToUpper(); Length; Split()
string opcao = "";
...
do
{
    ...
    switch (opcao)
    {
        case "1":
            ...
            Console.WriteLine("Quantos números quer gerar? ");
    ...
    Console.WriteLine("Precione algo para continuar!");
    Console.ReadKey();
} while (opcao != "4");

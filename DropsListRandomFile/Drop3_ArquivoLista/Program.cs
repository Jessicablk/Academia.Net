...
// opção é um objeto da classe string, logo tem atributos e métodos vindos da classe: ToUpper(); Length; Split()
string opcao = "";
do
{
    Console.Clear();
    ...
    switch (opcao)
    {
        case "1":
            ...
            {
                String nomeArquivo;
                Console.Write("Digite o nome do arquivo com valores glicêmicos que deseja ler: ");
        ...
        case "3":
            ...
            else
            {
                ...
                // regra do negócio para cálculo da mediana
